"""
Integration tests for Founder Connect feature.
...
from app.models.database import (
    ...
    ConnectionStatus, ValidationStatus, utcnow
)
    ...
    def test_complete_connection_workflow(self, app, test_user, test_user_2, authenticated_client, authenticated_client_2):
        ...
        with app.app_context():
            ...
            try:
                ...
                assert "recipient" in data4["connection_request"]
                recipient = data4["connection_request"]["recipient"]
...
class TestCreditSystemIntegration:
    ...
    def test_credit_tracking_and_reset(self, app, test_user, test_user_2, authenticated_client, authenticated_client_2):
        ...
        with app.app_context():
            ...
            test_user.usage_reset_date = datetime.utcnow().date() + timedelta(days=1)
            test_user.monthly_connections_used = 0
            db.session.commit()
