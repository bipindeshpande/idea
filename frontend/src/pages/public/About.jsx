    ...
    <section className="mx-auto max-w-6xl px-6 py-12">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          <div className="rounded-3xl border border-slate-200 dark:border-slate-700 bg-white/90 dark:bg-slate-800/90 p-8 shadow-soft">
            <h1 className="text-3xl font-semibold text-slate-900 dark:text-slate-100">About</h1>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl bg-brand-50/70 dark:bg-brand-900/30 p-5 text-sm text-brand-900 dark:text-brand-300">
              ...
              <div className="rounded-2xl bg-emerald-50/70 dark:bg-emerald-900/30 p-5 text-sm text-emerald-900 dark:text-emerald-300">
