...
# ============================================================================
# NEW FEATURES: Actions, Notes, Comparison, Smart Recommendations
# ============================================================================
...
def get_user_actions() -> Any:
    ...
    try:
        ...
        app.logger.exception("Failed to get user actions: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500
...
def create_user_action() -> Any:
    ...
    try:
        ...
        db.session.rollback()
        app.logger.exception("Failed to create action: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500


@app.put("/api/user/actions/<int:action_id>")
@require_auth
@limiter.limit("100 per hour")
def update_user_action(action_id: int) -> Any:
    ...
    try:
        ...
        db.session.rollback()
        app.logger.exception("Failed to update action: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500


@app.delete("/api/user/actions/<int:action_id>")
@require_auth
@limiter.limit("50 per hour")
def delete_user_action(action_id: int) -> Any:
    ...
    try:
        ...
        db.session.rollback()
        app.logger.exception("Failed to delete action: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500
...
def get_user_notes() -> Any:
    ...
    try:
        ...
        app.logger.exception("Failed to get user notes: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500
...
def create_user_note() -> Any:
    ...
    try:
        ...
        db.session.rollback()
        app.logger.exception("Failed to create note: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500


@app.put("/api/user/notes/<int:note_id>")
@require_auth
@limiter.limit("100 per hour")
def update_user_note(note_id: int) -> Any:
    ...
    try:
        ...
        db.session.rollback()
        app.logger.exception("Failed to update note: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500


@app.delete("/api/user/notes/<int:note_id>")
@require_auth
@limiter.limit("50 per hour")
def delete_user_note(note_id: int) -> Any:
    ...
    try:
        ...
        db.session.rollback()
        app.logger.exception("Failed to delete note: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500


# Session Comparison API
@app.post("/api/user/compare-sessions")
@require_auth
@limiter.limit("50 per hour")
def compare_sessions() -> Any:
    ...
    try:
        ...
        app.logger.exception("Failed to compare sessions: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500


# Smart Recommendations API
@app.get("/api/user/smart-recommendations")
@require_auth
@limiter.limit("50 per hour")
def get_smart_recommendations() -> Any:
    ...
    try:
        ...
        app.logger.exception("Failed to get smart recommendations: %s", exc)
        return jsonify({"success": False, "error": str(exc)}), 500
